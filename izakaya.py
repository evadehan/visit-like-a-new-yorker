...
# r = requests.get("https://api.yelp.com/v3/businesses/search?&location=New York&categories=izakaya", headers={'Authorization': 'Bearer wqKhAUDTo6BP_rEQ-E0HKR4To7lOm_b6oMC3S7BJfnI5gnyAgNPF4a5OGEw8OLe_1w1nA58qPVWwxazNiECvGsoFJGUqVcjqZQRvxQVNj9_LCOreKs6pxJdR_7CrXHYx'})
...
for i in data["businesses"]:
	...
	n=n+1
	print("\n## This is Izakaya Restaurant No. " + str(n) +" #########") 
	#pprint(i["name"])
	#pprint(i["price"])
	if i["rating"] > 4.0: #and i["price"] == "$$":
		...
		print("Restaurant '"+i["name"]+"' is not qualified\n")
...
with open('yelpdata.csv', 'a') as csvFile:
