...
r = requests.get("https://api.yelp.com/v3/businesses/search?&location=New York&term=trader joe's", headers={'Authorization': 'Bearer wqKhAUDTo6BP_rEQ-E0HKR4To7lOm_b6oMC3S7BJfnI5gnyAgNPF4a5OGEw8OLe_1w1nA58qPVWwxazNiECvGsoFJGUqVcjqZQRvxQVNj9_LCOreKs6pxJdR_7CrXHYx'})
...
with open('yelpdatatraderjoes.csv', 'a') as csvFile:
